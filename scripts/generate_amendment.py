...
from document_field_maps import AMENDMENT_FIELD_MAP, AMENDMENT_BUTTON_MAP

SOURCE_PDF = Path(r"C:\Users\Heath Shepard\Desktop\dossie\Dossie Forms\TREC Base\Amendment-to-Contract.pdf")
DEFAULT_DATA = {
...
def main():
    ...
    output_path = OUTPUT_DIR / "sample-amendment.pdf"
    mapped_text_values, mapped_button_values = map_fields(data, AMENDMENT_FIELD_MAP, AMENDMENT_BUTTON_MAP)
