#!/usr/bin/env node
/**
 * 40-11-place-fields.spec.js — TREC 40-11 Third Party Financing Addendum via "Place fields" mode.
 *
 ...
 *
 * form_template row: 8c7b1ac7-6469-49b0-83c9-f607fe402cdf
 */
...
async function main() {
  ...
  const evidence = await runPlaceFieldsWalk({
    ...
    base,
    headless,
    formTemplateId: '8c7b1ac7-6469-49b0-83c9-f607fe402cdf',
    signers: [
