#!/usr/bin/env node
/**
 * 36-11-place-fields.spec.js — TREC 36-11 HOA Addendum via "Place fields" mode.
 *
 ...
 *
 * form_template row: e6a833d1-d08c-4d82-8c34-60ed2aa188e0
 */
...
async function main() {
  ...
  const evidence = await runPlaceFieldsWalk({
    ...
    base,
    headless,
    formTemplateId: 'e6a833d1-d08c-4d82-8c34-60ed2aa188e0',
    signers: [
