#!/usr/bin/env node
/**
 * op-h-place-fields.spec.js — OP-H Sellers Disclosure Notice via "Place fields" mode.
 *
 ...
 *
 * form_template row: 299268e7-734e-4e5b-a003-0827f7857514
 */
...
async function main() {
  ...
  const evidence = await runPlaceFieldsWalk({
    ...
    base,
    headless,
    formTemplateId: '299268e7-734e-4e5b-a003-0827f7857514',
    signers: [
