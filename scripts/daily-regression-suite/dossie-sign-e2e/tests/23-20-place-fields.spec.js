#!/usr/bin/env node
/**
 * 23-20-place-fields.spec.js — TREC 23-20 New Home Incomplete via "Place fields" mode.
 *
 ...
 *
 * form_template row: 48ed472b-51ae-4c2b-8401-4b32fdb4b34a
 */
...
async function main() {
  ...
  const evidence = await runPlaceFieldsWalk({
    ...
    base,
    headless,
    formTemplateId: '48ed472b-51ae-4c2b-8401-4b32fdb4b34a',
    signers: [
