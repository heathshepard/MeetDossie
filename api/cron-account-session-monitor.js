...
require('./_lib/telegram-gate').install('cron-account-session-monitor');
...
module.exports = withTelemetry('cron-account-session-monitor', async function handler(req, res) {
