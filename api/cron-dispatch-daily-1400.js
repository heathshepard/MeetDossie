...
// api/cron-dispatch-daily-1400.js
//
...
// vercel.json with its OWN cron entry at schedule "0 14 * * *". Merged
...
//   - /api/cron-elevenlabs-monitor
//   - /api/cron-testimonial-request
//
...
const HANDLERS = [
  { name: 'cron-elevenlabs-monitor', mod: require('./cron-elevenlabs-monitor.js') },
  { name: 'cron-testimonial-request', mod: require('./cron-testimonial-request.js') },
];
...
module.exports = async function handler(req, res) {
  ...
  return res.status(anyFail ? 207 : 200).json({
    ok: !anyFail,
    dispatcher: 'cron-dispatch-daily-1400',
    schedule: '0 14 * * *',
