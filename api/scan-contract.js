...
- Paragraph 3 SALES PRICE: 3A cash portion, 3B sum financed, 3C TOTAL sales price.
  CRITICAL — SALES PRICE: Look ONLY at Paragraph 3C, which is labeled "Sales Price (Sum of A and B)" or "C. Sales Price". This line shows the TOTAL contract sales price. Extract ONLY this 3C number into salePrice. DO NOT extract from 3A (cash down payment) or 3B (sum of all financing). DO NOT extract from any other paragraph (like earnest money, option fee, or closing costs). Convert to plain number, no commas or dollar signs (e.g. "$250,000.00" -> 250000).
