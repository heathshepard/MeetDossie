...
- Paragraph 5 EARNEST MONEY AND TERMINATION OPTION:
  CRITICAL — OPTION DAYS: Look in Paragraph 5D for the termination option period. The contract typically says "Buyer shall have ___ days after the effective date" or shows a number filled in a blank (common values: 5, 7, 10). Extract ONLY the number of days as an integer into optionDays. Do not include words like "days" or "within" — just the integer. Also extract the option fee amount into optionFee.
