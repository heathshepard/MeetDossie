...
- Paragraph 5 EARNEST MONEY AND TERMINATION OPTION:
  CRITICAL — OPTION DAYS: Look ONLY in Paragraph 5B (labeled "TERMINATION OPTION" or "Option Period"), NOT in any other paragraph (NOT 6C, NOT 23, NOT anywhere else). In Paragraph 5B, find the sentence containing BOTH phrases: "unrestricted right to terminate" AND "days after the Effective Date". The sentence typically reads: "Seller grants Buyer the unrestricted right to terminate this contract by giving notice of termination to Seller within ___ days after the Effective Date." Extract ONLY the number (usually 5, 7, or 10) that appears immediately before "days after the Effective Date" in this sentence. Do NOT extract survey days from Paragraph 6C. Do NOT extract any other day count. Return as integer into optionDays. Also extract the option fee amount from 5D into optionFee.
