// Vercel Serverless Function: /api/cron-pull-comment-analytics
// PHASE 4 - Comment Analytics Collection
//
// Runs every 4 hours have been pulled.
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    await recordCronRun('cron-pull-comment-analytics', 'ok', {
      analysis_date: today,
    ...
    console.error('[cron-pull-comment-analytics] crashed:', e);
    await recordCronRun('cron-pull-comment-analytics', 'error', { error: e.message });
