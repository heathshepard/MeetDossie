...
// api/cron-dispatch-daily-0900.js
//
...
// vercel.json with its OWN cron entry at schedule "0 9 * * *". Merged
...
//   - /api/cron-regression-suite
//   - /api/cron-daily-group5-posts
//
...
const HANDLERS = [
  { name: 'cron-regression-suite', mod: require('./cron-regression-suite.js') },
  { name: 'cron-daily-group5-posts', mod: require('./cron-daily-group5-posts.js') },
];
...
module.exports = async function handler(req, res) {
  ...
  return res.status(anyFail ? 207 : 200).json({
    ok: !anyFail,
    dispatcher: 'cron-dispatch-daily-0900',
    schedule: '0 9 * * *',
